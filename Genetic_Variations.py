# Predicting the effects of Genetic Variations on Cancer Treatments using LGBM
"""
Dataset information:
    Four Files:
...
# FUNCTION TO DETERMINE TEXT LENGTH
def textlen(train):
...
# BAG OF WORDS AND CONVERTING THE VARIABLES INTO CATEGORICAL VARIABLES
